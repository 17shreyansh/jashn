...
export function Footer() {
  ...
  return (
    <footer className="bg-[#2d3e2d] text-white mt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-serif text-xl font-bold">Jashn Planners</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/events" className="text-white/70 hover:text-primary transition-colors">Event Planning</Link></li>
              <li><Link href="/tours" className="text-white/70 hover:text-primary transition-colors">Tours & Travel</Link></li>
            </ul>
          </div>
